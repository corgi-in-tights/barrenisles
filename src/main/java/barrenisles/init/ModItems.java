...
public class ModItems
{
    ...
    public final static SoundEvent BARREN_NIGHT_SOUND_EVENT = new SoundEvent(new ResourceLocation(BarrenIslesMod.MODID, "barren_night"));
    ...
    static {
    	...
    	barren_night_disc = ITEMS.register("music_disc_barren_night",
    			() -> new DesertDiscItem(20, BARREN_NIGHT_SOUND_EVENT,
    					new Item.Properties()
    					.stacksTo(1)
    					.tab(BARREN_ISLES)
    					.rarity(Rarity.RARE)));
