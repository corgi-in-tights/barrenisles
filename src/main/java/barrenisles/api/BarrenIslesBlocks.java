...
public class BarrenIslesBlocks {
	
	// Plants
	
	public static RegistryObject<Block> agave;  
	...
	public static RegistryObject<Block> poison_ivy;
	public static RegistryObject<Block> suspicious_berry_bush;
	public static RegistryObject<Block> thornweed;
	public static RegistryObject<Block> winecup;
	...
	public static RegistryObject<Block> gold_vase;
	public static RegistryObject<Block> vase;
}