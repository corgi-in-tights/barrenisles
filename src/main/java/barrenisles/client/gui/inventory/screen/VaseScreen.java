...
public class VaseScreen extends ContainerScreen<VaseContainer> implements IHasContainer<VaseContainer> {
   private static final ResourceLocation CONTAINER_BACKGROUND = new ResourceLocation(BarrenIslesMod.MODID, "textures/gui/container/vase.png");

   public VaseScreen(VaseContainer menu, PlayerInventory playerInventory, ITextComponent title) {
