...
public class BadlandsTempleStructure extends StructureFeature<DefaultFeatureConfig> {
    public BadlandsTempleStructure(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    private static final Pool<SpawnSettings.SpawnEntry> STRUCTURE_MONSTERS = Pool.of(
            new SpawnSettings.SpawnEntry(EntityType.HUSK, 1, 1,2),
            new SpawnSettings.SpawnEntry(EntityType.BAT, 1, 1, 1)
    );
