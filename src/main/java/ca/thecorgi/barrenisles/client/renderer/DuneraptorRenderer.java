...
public class DuneraptorRenderer extends GeoEntityRenderer<Duneraptor> {
    public DuneraptorRenderer(EntityRendererFactory.Context ctx) {
        super(ctx, new DuneraptorModel());
    }

    @Override
    public RenderLayer getRenderType(Duneraptor animatable, float partialTicks, MatrixStack stack,
