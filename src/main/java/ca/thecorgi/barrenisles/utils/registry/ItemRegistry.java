...
public class ItemRegistry {
    ...
    public static final Item ROASTED_DRUMSTICK = new Item(new FabricItemSettings().group(MAIN_GROUP).food(BarrenIslesFoodComponents.ROASTED_DRUMSTICK_C));
    ...
    public static void init() {
        ...
        Registry.register(Registry.ITEM, new Identifier(ModID, "roasted_drumstick"), ROASTED_DRUMSTICK);
