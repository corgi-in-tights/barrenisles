...
public class DuneraptorEntity extends PathAwareEntity implements IAnimatable {
    AnimationFactory factory = new AnimationFactory(this);

    public DuneraptorEntity(EntityType<? extends PathAwareEntity> type, World worldIn) {
        super(type, worldIn);
