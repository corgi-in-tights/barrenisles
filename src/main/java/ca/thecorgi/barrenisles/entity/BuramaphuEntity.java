...
//            event.getController().setAnimation(new AnimationBuilder().addAnimation("buramaphu.run", true));
//        } else if (this.isAttacking()) {
//            event.getController().setAnimation(new AnimationBuilder().addAnimation("buramaphu.attack", true));
//        } else {
